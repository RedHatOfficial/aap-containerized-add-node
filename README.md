...
Upstream path to fold this into the containerized installer: [INSTALLER_PLAN.md](INSTALLER_PLAN.md). Full vendored installer trees (upstream + `add_execution_nodes`) live in [installer/](installer/).
