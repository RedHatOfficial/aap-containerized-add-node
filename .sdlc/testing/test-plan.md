...
| 2.7.x | RHEL 9 | RHEL 9 | P1 | Tested |
| 2.7.x | RHEL 9 | RHEL 10 | P1 | Tested |
...
1. **Cluster topologies untested** — AIO validated, HA cluster needs validation
2. **No automated scenario runner** — Manual execution required
3. **No molecule tests** — Future enhancement
