...
**Blocked?** See [Troubleshooting](../collection/TROUBLESHOOTING.md)
...
|--------------|----------|--------------|
| Add one EN that can reach controller | Single EN | [inventory-single-en.yml](../examples/inventory-examples.md#single-execution-node) |
| Add multiple ENs that can reach controller | Parallel ENs | [inventory-parallel-ens.yml](../examples/inventory-examples.md#parallel-execution-nodes) |
| Add EN behind a hop node | EN via Hop | [inventory-en-via-hn.yml](../examples/inventory-examples.md#en-via-hop) |
| Add multiple ENs behind one hop | Fan-out | [inventory-fanout-behind-hop.yml](../examples/inventory-examples.md#fan-out) |
| Cross multiple network tiers | Multi-hop chain | [inventory-multi-hop-chain.yml](../examples/inventory-examples.md#multi-hop) |
| On-prem nodes → cloud controller | Hybrid cloud | [inventory-hybrid-cloud.yml](../examples/inventory-examples.md#hybrid-cloud) |

**Not sure?** See [Topology](QUICKSTART.md) for detailed diagrams.
...
See [Troubleshooting](../collection/TROUBLESHOOTING.md) for:
...
- **Custom TLS**: See [Conventions](../collection/CONVENTIONS.md) for BYO certificate options
